...
class Applications(interactions.Extension):
    ...
    async def srm(self, ctx):
        ...
        interactions.Button(style=interactions.ButtonStyle.PRIMARY, custom_id="4mans", label="4mans"),
        interactions.Button(style=interactions.ButtonStyle.PRIMARY, custom_id="2mans", label="2mans"),
        interactions.Button(style=interactions.ButtonStyle.PRIMARY, custom_id="6mans", label="6mans")
        ])                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       ", label="MENA")])
    ...
    async def on_component(self, ctx):
        ...
        if ctx.custom_id.startswith("accept"):
            ...
            user = await guild.get_member(memberId)
            await user.send(
                "We appreciate you wanting to help out in the server! But we have decided are not what we are looking for in a mod right now, thank you for applying.\n\nSincerely - The Mod Team :)" )
